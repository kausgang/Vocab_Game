...
// var client = Owlbot("5a7eb608e2f77faca3115a96aaf7db1c5a0d50f4");
var client = Owlbot(config.TOKEN);
...
router.get("/", function (req, res, next) {
  ...
  if (game == "game_1") var filename = path.join("./public/REPORT/game_1.json");
  if (game == "game_2") var filename = path.join("./public/REPORT/game_2.json");
